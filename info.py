...
BIND_ADRESS = environ.get('WEB_SERVER_BIND_ADDRESS', '0.0.0.0')
FQDN = environ.get('FQDN', BIND_ADRESS) if not ON_HEROKU or environ.get('FQDN') else APP_NAME+'.herokuapp.com'
